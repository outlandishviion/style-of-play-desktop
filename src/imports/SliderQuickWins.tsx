import svgPaths from "./svg-99e9og1j82";
...
export default function SliderQuickWins() {
  return (
    <div className="relative rounded-[30.423px] size-full" data-name="Slider: Quick Wins">
