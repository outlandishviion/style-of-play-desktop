import svgPaths from "./svg-7005v7uf9r";
...
export default function LocalStyleOfPlayPresets() {
  return (
    <div className="backdrop-blur-[6px] backdrop-filter relative rounded-[999px] size-full" data-name="[Local] Style of play presets">
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex gap-[24px] items-center p-[7px] relative size-full">
          <Background />
          <LocalPersetsGroup />
          <LocalPersetsGroup1 />
        </div>
