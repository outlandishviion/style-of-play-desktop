import svgPaths from "./svg-edg20yq3d7";
...
export default function SliderCasualFun() {
  return (
    <div className="relative rounded-[30.423px] size-full" data-name="Slider: Casual Fun">
      ...
      <div className="flex flex-row items-center justify-end size-full">
        <div className="box-border content-stretch flex gap-[5.07px] items-center justify-end pl-[176px] pr-[43px] py-[5.07px] relative size-full">
          <Frame />
        </div>
      </div>
    </div>
