import svgPaths from "./svg-v97vcpiqiu";
...
export default function SliderBigThrills() {
  return (
    <div className="relative rounded-[30.423px] size-full" data-name="Slider: big thrills">
