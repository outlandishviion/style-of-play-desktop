import svgPaths from "./svg-wnyisx1as0";
...
export default function SliderCustom() {
  return (
    <div className="relative rounded-[30.423px] size-full" data-name="Slider: custom">
      ...
      <div className="flex flex-row items-center justify-end size-full">
        <div className="box-border content-stretch flex gap-[5.07px] items-center justify-end pl-[44px] pr-[131px] py-[5.07px] relative size-full">
          <Frame />
        </div>
      </div>
    </div>
