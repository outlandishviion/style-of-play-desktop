import svgPaths from "./svg-arzcnt1yh0";
import imgImage1 from "figma:asset/07993cf3e1a35c4dc4039adc682eadf1ac28daab.png";
...
function Background() {
  return (
    <div className="absolute bg-[#c774f5] bottom-[7px] box-border content-stretch flex items-center left-[184px] overflow-clip rounded-[999px] shadow-[0px_0px_20px_6px_#c774f5] top-[7px]" data-name="background">
      <LocalPresetBtn />
    </div>
  );
}
...
function Frame1() {
  return (
    <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-[748px]">
      <Image />
      <p className="font-['Open_Sans:Regular',sans-serif] font-normal leading-[1.6] relative shrink-0 text-[#d7a7f8] text-[12px] w-[660px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        For players seeking lasting gameplay with steady progress and the occasional big win.
      </p>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Chips / Icon idicator">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_2049_13842)" id="Error handling">
          <path d={svgPaths.p30769300} fill="var(--fill-0, white)" id="Vector" />
          <path d={svgPaths.p5810880} fill="var(--fill-0, #202735)" id="Vector_2" />
        </g>
        <defs>
          <clipPath id="clip0_2049_13842">
...
function Chips2() {
  return (
    <div className="bg-[rgba(255,255,255,0.3)] h-[36px] relative rounded-[18px] shrink-0" data-name="Chips">
      ...
      <div aria-hidden="true" className="absolute border border-[#c774f5] border-solid inset-0 pointer-events-none rounded-[18px]" />
    </div>
  );
}
...
function Slider() {
  return (
    <div className="h-[36px] relative rounded-[30.423px] shrink-0 w-full" data-name="Slider">
      <div aria-hidden="true" className="absolute border border-[#c774f5] border-solid inset-[-1px] pointer-events-none rounded-[31.423px]" />
...
function Description() {
  return (
    <div className="bg-[rgba(126,87,194,0.1)] box-border content-stretch flex flex-col gap-[8px] items-center justify-center overflow-clip pb-[16px] pt-[8px] px-[16px] relative rounded-[16px] shrink-0 w-[788px]" data-name="Description">
      <Frame1 />
      <SelectionWrapper />
    </div>
  );
...
export default function Frame12() {
  return (
    <div className="backdrop-blur-[6px] backdrop-filter relative rounded-[24px] size-full" style={{ backgroundImage: "linear-gradient(90deg, rgba(126, 87, 194, 0.15) 0%, rgba(126, 87, 194, 0.15) 100%), linear-gradient(90deg, rgba(255, 255, 255, 0.04) 0%, rgba(255, 255, 255, 0.04) 100%)" }}>
      ...
      <div aria-hidden="true" className="absolute border border-[rgba(126,87,194,0.5)] border-solid inset-0 pointer-events-none rounded-[24px]" />
    </div>
  );
}