import svgPaths from "./svg-yzmlrq1ui1";
import imgImage1 from "figma:asset/88e76ff33d0cccf20984fc79ac231b41083ede68.png";
...
function Background() {
  return (
    <div className="absolute bg-[#ff9800] bottom-[7px] box-border content-stretch flex items-center left-[263px] overflow-clip rounded-[999px] shadow-[0px_0px_20px_6px_#ff9800] top-[7px]" data-name="background">
      <LocalPresetBtn />
    </div>
  );
}
...
function Frame1() {
  return (
    <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-[748px]">
      <Image />
      <p className="font-['Open_Sans:Regular',sans-serif] font-normal leading-[1.6] relative shrink-0 text-[#ffcb80] text-[12px] w-[660px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        For players who enjoy unpredictable rounds packed with excitement and bigger payouts.
      </p>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Chips / Icon idicator">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_2049_21946)" id="Error handling">
          <path d={svgPaths.p30769300} fill="var(--fill-0, white)" id="Vector" />
          <path d={svgPaths.p7e9ed00} fill="var(--fill-0, #202735)" id="Vector_2" />
        </g>
        <defs>
          <clipPath id="clip0_2049_21946">
...
function Chips3() {
  return (
    <div className="bg-[rgba(255,255,255,0.3)] h-[36px] relative rounded-[18px] shrink-0" data-name="Chips">
      ...
      <div aria-hidden="true" className="absolute border border-[#ff9800] border-solid inset-0 pointer-events-none rounded-[18px]" />
    </div>
  );
}
...
function Slider() {
  return (
    <div className="h-[36px] relative rounded-[30.423px] shrink-0 w-full" data-name="Slider">
      <div aria-hidden="true" className="absolute border border-[#ff9800] border-solid inset-[-1px] pointer-events-none rounded-[31.423px]" />
      <div className="flex flex-row items-center justify-end size-full">
        <div className="box-border content-stretch flex gap-[5.07px] h-[36px] items-center justify-end pl-[131px] pr-[43px] py-[5.07px] relative w-full">
          <Frame />
        </div>
      </div>
    </div>
...
function Description() {
  return (
    <div className="bg-[rgba(255,152,0,0.1)] box-border content-stretch flex flex-col gap-[8px] items-center justify-center overflow-clip pb-[16px] pt-[8px] px-[16px] relative rounded-[16px] shrink-0 w-[788px]" data-name="Description">
      <Frame1 />
      <SelectionWrapper />
    </div>
  );
...
export default function Frame12() {
  return (
    <div className="backdrop-blur-[6px] backdrop-filter relative rounded-[24px] size-full" style={{ backgroundImage: "linear-gradient(90deg, rgba(255, 152, 0, 0.15) 0%, rgba(255, 152, 0, 0.15) 100%), linear-gradient(90deg, rgba(255, 255, 255, 0.04) 0%, rgba(255, 255, 255, 0.04) 100%)" }}>
      ...
      <div aria-hidden="true" className="absolute border border-[rgba(255,152,0,0.5)] border-solid inset-0 pointer-events-none rounded-[24px]" />
    </div>
  );
}