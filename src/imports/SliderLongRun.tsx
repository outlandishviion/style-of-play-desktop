import svgPaths from "./svg-jnri0f0bxe";
...
export default function SliderLongRun() {
  return (
    <div className="relative rounded-[30.423px] size-full" data-name="Slider: Long run">
      ...
      <div className="flex flex-row items-center justify-end size-full">
        <div className="box-border content-stretch flex gap-[5.07px] items-center justify-end pl-[263px] pr-0 py-[5.07px] relative size-full">
          <Frame />
        </div>
      </div>
    </div>
