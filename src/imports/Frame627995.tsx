import svgPaths from "./svg-g860rvdxbo";
import imgImage1 from "figma:asset/8cd36847a179b62ce8ca1840ae3076240edea57b.png";
...
function Background() {
  return (
    <div className="absolute bg-[#b12e5f] bottom-[7px] box-border content-stretch flex items-center left-[344px] overflow-clip rounded-[999px] shadow-[0px_0px_20px_6px_#b12e5f] top-[7px]" data-name="background">
      <LocalPresetBtn />
    </div>
  );
}
...
function Frame1() {
  return (
    <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-[748px]">
      <Image />
      <p className="font-['Open_Sans:Regular',sans-serif] font-normal leading-[1.6] relative shrink-0 text-[#d68aa8] text-[12px] w-[660px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        For players confident in higher bets, where fewer wins can lead to major rewards.
      </p>
    </div>
  );
}
...
function Chips4() {
  return (
    <div className="bg-[rgba(255,255,255,0.3)] h-[36px] relative rounded-[18px] shrink-0" data-name="Chips">
      ...
      <div aria-hidden="true" className="absolute border border-[#b12e5f] border-solid inset-0 pointer-events-none rounded-[18px]" />
    </div>
  );
}
...
function Description() {
  return (
    <div className="bg-[rgba(163,38,56,0.1)] box-border content-stretch flex flex-col gap-[8px] items-center justify-center overflow-clip pb-[16px] pt-[8px] px-[16px] relative rounded-[16px] shrink-0 w-[788px]" data-name="Description">
      <Frame1 />
      <SelectionWrapper />
    </div>
  );
...
export default function Frame12() {
  return (
    <div className="backdrop-blur-[6px] backdrop-filter relative rounded-[24px] size-full" style={{ backgroundImage: "linear-gradient(90deg, rgba(163, 38, 56, 0.15) 0%, rgba(163, 38, 56, 0.15) 100%), linear-gradient(90deg, rgba(255, 255, 255, 0.04) 0%, rgba(255, 255, 255, 0.04) 100%)" }}>
      ...
      <div aria-hidden="true" className="absolute border border-[rgba(163,38,56,0.5)] border-solid inset-0 pointer-events-none rounded-[24px]" />
    </div>
  );
}