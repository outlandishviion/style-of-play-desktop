import svgPaths from "./svg-j7z6ptnmie";
import imgImage1 from "figma:asset/b5d4cb76c61ad972c3c8671d9b71bf4386c13a2a.png";
...
function Background() {
  return (
    <div className="absolute bg-[#42a5f5] bottom-[7px] box-border content-stretch flex items-center left-[96px] overflow-clip rounded-[999px] shadow-[0px_0px_20px_6px_#42a5f5] top-[7px]" data-name="background">
      <LocalPresetBtn />
    </div>
  );
}
...
function Frame1() {
  return (
    <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-[748px]">
      <Image />
      <p className="font-['Open_Sans:Regular',sans-serif] font-normal leading-[1.6] relative shrink-0 text-[#a1d2fa] text-[12px] w-[660px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        For players who like easy, colorful games with balanced wins and relaxed play sessions.
      </p>
    </div>
  );
}
  ...
  return (
    <div className="h-[24px] relative shrink-0 w-[41.143px]" data-name="Volatility dial arc / small">
      <div className="absolute bottom-[-54.94%] left-1/2 top-[26.31%] translate-x-[-50%] w-[30.872px]" data-name="Line">
        <div className="absolute bottom-1/2 left-0 right-1/2 top-[49.69%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 1">
            <g id="Line" opacity="0.3">
              <mask fill="white" id="path-1-inside-1_2049_12234">
                <path d={svgPaths.p24999880} />
              </mask>
              <path d={svgPaths.p24999880} fill="url(#paint0_linear_2049_12234)" mask="url(#path-1-inside-1_2049_12234)" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.2" strokeWidth="2" />
            </g>
            <defs>
              <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_2049_12234" x1="31.5718" x2="-0.612408" y1="-0.0622982" y2="0.232969">
...
function Chips1() {
  return (
    <div className="bg-[rgba(255,255,255,0.3)] h-[36px] relative rounded-[18px] shrink-0" data-name="Chips">
      ...
      <div aria-hidden="true" className="absolute border border-[#42a5f5] border-solid inset-0 pointer-events-none rounded-[18px]" />
    </div>
  );
}
...
function Slider() {
  return (
    <div className="h-[36px] relative rounded-[30.423px] shrink-0 w-full" data-name="Slider">
      <div aria-hidden="true" className="absolute border border-[#42a5f5] border-solid inset-[-1px] pointer-events-none rounded-[31.423px]" />
      <div className="flex flex-row items-center justify-end size-full">
        <div className="box-border content-stretch flex gap-[5.07px] h-[36px] items-center justify-end pl-[176px] pr-[43px] py-[5.07px] relative w-full">
          <Frame />
        </div>
      </div>
    </div>
...
function Description() {
  return (
    <div className="bg-[rgba(66,165,245,0.1)] relative rounded-[16px] shrink-0 w-[788px]" data-name="Description">
      <div className="box-border content-stretch flex flex-col gap-[8px] items-center justify-center overflow-clip pb-[16px] pt-[8px] px-[16px] relative rounded-[inherit] w-[788px]">
        <Frame1 />
        <SelectionWrapper />
      </div>
      <div aria-hidden="true" className="absolute border border-[rgba(66,165,245,0.2)] border-solid inset-0 pointer-events-none rounded-[16px]" />
    </div>
  );
}
...
export default function Frame12() {
  return (
    <div className="backdrop-blur-[6px] backdrop-filter relative rounded-[24px] size-full" style={{ backgroundImage: "linear-gradient(90deg, rgba(66, 165, 245, 0.15) 0%, rgba(66, 165, 245, 0.15) 100%), linear-gradient(90deg, rgba(255, 255, 255, 0.04) 0%, rgba(255, 255, 255, 0.04) 100%)" }}>
      ...
      <div aria-hidden="true" className="absolute border border-[rgba(66,165,245,0.5)] border-solid inset-0 pointer-events-none rounded-[24px]" />
    </div>
  );
}