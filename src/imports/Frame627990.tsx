import svgPaths from "./svg-xrpvh9n26n";
import imgImage1 from "figma:asset/81846ac04e3f676a39230c95c198e251334e72a4.png";
...
function Background() {
  return (
    <div className="absolute bottom-[7px] right-[7px] rounded-[999px] top-[7px]" data-name="background">
...
function LocalPersetsGroup1() {
  return (
    <button className="box-border content-stretch cursor-pointer flex items-center p-0 relative shrink-0" data-name="[Local[ Persets group">
      <LocalPresetBtn6 />
    </button>
  );
}
...
function Frame1() {
  return (
    <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-[748px]">
      <Image />
      <p className="basis-0 font-['Open_Sans:Regular',sans-serif] font-['Open_Sans:SemiBold',sans-serif] font-normal font-semibold grow leading-[1.6] min-h-px min-w-px relative shrink-0 text-[0px] text-[12px] text-[rgba(255,255,255,0.8)]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <span style={{ fontVariationSettings: "'wdth' 100" }}>{`You are in full control. Freely combine Volatility and RTP, or simply choose one of our `}</span>
        <span style={{ fontVariationSettings: "'wdth' 100" }}>Style of play</span>
        <span style={{ fontVariationSettings: "'wdth' 100" }}>{` presets above.`}</span>
      </p>
    </div>
  );
}
...
function Slider() {
  return (
    <div className="h-[36px] relative rounded-[30.423px] shrink-0 w-full" data-name="Slider">
      <div aria-hidden="true" className="absolute border border-[rgba(255,255,255,0.1)] border-solid inset-[-1px] pointer-events-none rounded-[31.423px]" />
      <div className="flex flex-row items-center justify-end size-full">
        <div className="box-border content-stretch flex gap-[5.07px] h-[36px] items-center justify-end pl-[44px] pr-[131px] py-[5.07px] relative w-full">
          <Frame />
        </div>
      </div>
    </div>
...
function Description() {
  return (
    <div className="bg-[rgba(255,255,255,0.05)] box-border content-stretch flex flex-col gap-[8px] items-center justify-center overflow-clip pb-[16px] pt-[8px] px-[16px] relative rounded-[16px] shrink-0 w-[788px]" data-name="Description">
      <Frame1 />
      <SelectionWrapper />
    </div>
  );
...
export default function Frame12() {
  return (
    <div className="backdrop-blur-[6px] backdrop-filter bg-[rgba(255,255,255,0.04)] relative rounded-[24px] size-full">
